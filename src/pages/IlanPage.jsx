  ...
  return (
    <div className="ilan-page">
      <header className="ilan-header">
        ...
        <p>Size uygun ilanları filtreleyin ya da üzerine tıklayıp detayına bakın.</p>
      </header>
      ...
      <div className="ilan-list">
        {filtered.length === 0 && (
          <p className="no-result">Kriterlere uyan ilan bulunamadı.</p>
        )}
        {filtered.map(ilan => (
          <div
            key={ilan._id}
          ...
          >
            ...
            <div className="ilan-right">
              {new Date(ilan.baslangicTarihi).toLocaleDateString()} &ndash;{' '}
